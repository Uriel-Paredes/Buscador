                        ...
                        <div class="card-body">
                            <form method="post" autocomplete="off">
                                ...
                                <div class="form-group" style="text-align:center;">
                                    <input type="checkbox" name="bd['acm']" id="checkboxACM">
                                    <b>ACM</b>
                                    <input type="checkbox" name="bd['scienceDirect']" id="checkboxScienceDirect">
                                    <b>ScienceDirect</b>
                                    <input type="checkbox" name="bd['ieeeXplore']" id="checkboxIEEEXplore">
                                    <b>IEEE Xplore</b>
                                    <input type="checkbox" name="bd['springerLink']" id="checkboxSpringerLink">
                                    <b>SpringerLink</b>
                                </div>
                                <p></p>
